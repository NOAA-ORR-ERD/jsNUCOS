...
var issubclass = function(args, kwargs) {
  ...
  bases = C.__bases__;
  i = 0;
  while (( i ) < __get__(bases, "length", "missing attribute `length` - line 228: while i < bases.length:")) {
    if (issubclass([((bases instanceof Array) ? bases[i] : __get__(bases, "__getitem__", "line 229: if issubclass( bases[i], B ):")([i], __NULL_OBJECT__)), B], __NULL_OBJECT__)) {
      return true;
    }
    i += 1;
  }
...
var sum = function(args, kwargs) {
  ...
  __iterator__12 = __get__(__get__(arr, "__iter__", "no iterator - line 478: for b in arr:"), "__call__")([], __NULL_OBJECT__);
  var __next__12;
...
var next = function(args, kwargs) {
  ...
  return __get__(__get__(obj, "next", "missing attribute `next` - line 484: return obj.next()"), "__call__")();
...
var map = function(args, kwargs) {
  ...
  __iterator__13 = __get__(__get__(objs, "__iter__", "no iterator - line 487: for ob in objs:"), "__call__")([], __NULL_OBJECT__);
  var __next__13;
...
var filter = function(args, kwargs) {
  ...
  __iterator__14 = __get__(__get__(objs, "__iter__", "no iterator - line 494: for ob in objs:"), "__call__")([], __NULL_OBJECT__);
  var __next__14;
...
var min = function(args, kwargs) {
  ...
  __iterator__15 = __get__(__get__(lst, "__iter__", "no iterator - line 501: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__15;
...
var max = function(args, kwargs) {
  ...
  __iterator__16 = __get__(__get__(lst, "__iter__", "no iterator - line 507: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__16;
...
var __Iterator___init__ = function(args, kwargs) {
  ...
  self.obj_get = __get__(obj, "get", "missing attribute `get` - line 535: self.obj_get = obj.get  ## cache this for speed");
  ...
  if (( pointer ) !== null) {
    ...
    if (js_object) {
      ...
      if (ob instanceof Array) {
        ...
        __iterator__17 = __get__(__get__(ob, "__iter__", "no iterator - line 597: for o in ob:"), "__call__")([], __NULL_OBJECT__);
        var __next__17;
        ...
        while (( __iterator__17.index ) < __iterator__17.length) {
          ...
          if (o instanceof Array) {
            ...
            v = o["value"];
                    ...
                    try {
__get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 604: self.__setitem__( k,v )"), "__call__")([k, v], __NULL_OBJECT__);
          } catch(__exception__) {
...
throw new KeyError("error in dict init, bad key");
        ...
        if (isinstance([ob, dict], __NULL_OBJECT__)) {
          ...
          __iterator__18 = __get__(__get__(__jsdict_keys(ob), "__iter__", "no iterator - line 608: for key in ob.keys():"), "__call__")([], __NULL_OBJECT__);
          var __next__18;
          __next__18 = __get__(__iterator__18, "next");
          while (( __iterator__18.index ) < __iterator__18.length) {
            key = __next__18();
            value = ((ob instanceof Array) ? ob[key] : __get__(ob, "__getitem__", "line 609: value = ob[ key ]")([key], __NULL_OBJECT__));
            __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 610: self.__setitem__( key, value )"), "__call__")([key, value], __NULL_OBJECT__);
          }
        } else {
...
var __dict_jsify = function(args, kwargs) {
  ...
  __iterator__19 = __get__(__get__(keys, "__iter__", "no iterator - line 617: for key in keys:"), "__call__")([], __NULL_OBJECT__);
  var __next__19;
  __next__19 = __get__(__iterator__19, "next");
  while (( __iterator__19.index ) < __iterator__19.length) {
    key = __next__19();
    value = __get__(self["$wrapped"], "__getitem__", "line 618: value = self[...][key]")([key], __NULL_OBJECT__);
    if (typeof(value)==="object") {
      if (__get__(hasattr, "__call__")([value, "jsify"], __NULL_OBJECT__)) {
        __get__(__get__(self["$wrapped"], "__setitem__"), "__call__")([key, __get__(__get__(value, "jsify", "missing attribute `jsify` - line 621: self[...][key] = value.jsify()"), "__call__")()], {});
      }
    } else {
...
var __dict_has_key = function(args, kwargs) {
  ...
  if (typeof(key) === 'object' || typeof(key) === 'function') {
    key = __get__(key, "__uid__", "missing attribute `__uid__` - line 634: key = key.__uid__");
  }
  if (key in __dict) {
    return true;
  } else {
...
var __dict_update = function(args, kwargs) {
  ...
  __iterator__20 = __get__(__get__(other, "__iter__", "no iterator - line 640: for key in other:"), "__call__")([], __NULL_OBJECT__);
  var __next__20;
  __next__20 = __get__(__iterator__20, "next");
  while (( __iterator__20.index ) < __iterator__20.length) {
    key = __next__20();
    __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 641: self.__setitem__( key, other[key] )"), "__call__")([key, ((other instanceof Array) ? other[key] : __get__(other, "__getitem__", "line 641: self.__setitem__( key, other[key] )")([key], __NULL_OBJECT__))], __NULL_OBJECT__);
  }
...
var __dict_items = function(args, kwargs) {
  ...
  __iterator__21 = __get__(__get__(__jsdict_keys(self), "__iter__", "no iterator - line 644: for key in self.keys():"), "__call__")([], __NULL_OBJECT__);
  var __next__21;
  __next__21 = __get__(__iterator__21, "next");
  while (( __iterator__21.index ) < __iterator__21.length) {
    key = __next__21();
    __get__(__get__(arr, "append", "missing attribute `append` - line 645: arr.append( [key, self[key]] )"), "__call__")([[key, __get__(self, "__getitem__")([key], __NULL_OBJECT__)]], __NULL_OBJECT__);
  }
  return arr;
...
var __dict_set = function(args, kwargs) {
  ...
  var key = __args__['key'];
  var value = __args__['value'];
  __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 653: self.__setitem__(key, value)"), "__call__")([key, value], __NULL_OBJECT__);
...
var __array___init__ = function(args, kwargs) {
  ...
  self.itemsize = __get__(__get__(self, "typecodes", "missing attribute `typecodes` - line 837: self.itemsize = self.typecodes[ typecode ]"), "__getitem__", "line 837: self.itemsize = self.typecodes[ typecode ]")([typecode], __NULL_OBJECT__);
  ...
  self.buffer = buff;
  __get__(__get__(self, "fromlist", "missing attribute `fromlist` - line 858: self.fromlist( initializer )"), "__call__")([initializer], __NULL_OBJECT__);
...
var __array___contains__ = function(args, kwargs) {
  ...
  var self = __args__['self'];
  var value = __args__['value'];
  arr = __get__(__get__(self, "to_array", "missing attribute `to_array` - line 864: arr = self.to_array()"), "__call__")();
...
var __array___getitem__ = function(args, kwargs) {
  ...
  func_name = ("get" + __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 872: func_name = 'get'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 872: func_name = 'get'+self.typecode_names[ self.typecode ]")([self.typecode], __NULL_OBJECT__));
...
var __array___setitem__ = function(args, kwargs) {
  ...
  offset = (step * index);
  dataview = self.dataview;
  func_name = ("set" + __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 888: func_name = 'set'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 888: func_name = 'set'+self.typecode_names[ self.typecode ]")([self.typecode], __NULL_OBJECT__));
  func = dataview[func_name].bind(dataview);
  if (( offset ) < self.bytes) {
    if (self.typecode==="float8") {
...
var __array_fromlist = function(args, kwargs) {
  ...
  size = (length * step);
  dataview = self.dataview;
  func_name = ("set" + __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 908: func_name = 'set'+self.typecode_names[ typecode ]"), "__getitem__", "line 908: func_name = 'set'+self.typecode_names[ typecode ]")([typecode], __NULL_OBJECT__));
  func = dataview[func_name].bind(dataview);
  if (( size ) <= self.bytes) {
    i = 0;
    offset = 0;
    while (( i ) < length) {
      item = ((lst instanceof Array) ? lst[i] : __get__(lst, "__getitem__", "line 913: item = lst[i]")([i], __NULL_OBJECT__));
      if (typecode==="float8") {
        item *= self._norm_set;
      } else {
        if (typecode==="float16") {
...
var __array_append = function(args, kwargs) {
  ...
  var value = __args__['value'];
  length = self.length;
  __get__(__get__(self, "resize", "missing attribute `resize` - line 936: self.resize( self.length + 1 )"), "__call__")([(self.length + 1)], __NULL_OBJECT__);
...
var __array_extend = function(args, kwargs) {
  ...
  __iterator__26 = __get__(__get__(lst, "__iter__", "no iterator - line 939: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__26;
  __next__26 = __get__(__iterator__26, "next");
  while (( __iterator__26.index ) < __iterator__26.length) {
    value = __next__26();
    __get__(__get__(self, "append", "missing attribute `append` - line 940: self.append( value )"), "__call__")([value], __NULL_OBJECT__);
  }
...
var __array_to_list = function(args, kwargs) {
  ...
  var self = __args__['self'];
  return __get__(__get__(self, "to_array", "missing attribute `to_array` - line 950: return self.to_array()"), "__call__")();
...
var __array_to_ascii = function(args, kwargs) {
  ...
  var self = __args__['self'];
  string = "";
  arr = __get__(__get__(self, "to_array", "missing attribute `to_array` - line 953: arr = self.to_array()"), "__call__")();
  i = 0;
  length = __get__(arr, "length", "missing attribute `length` - line 954: i = 0; length = arr.length");
  while (( i ) < length) {
    var num = arr[i];
...
__version__ = "1.3.0";
ConvertDataUnits = __jsdict([["Length", __jsdict([["meter", [1.0, ["m", "meters", "metre"]]], ["centimeter", [0.01, ["cm", "centimeters"]]], ["millimeter", [0.001, ["mm", "millimeters"]]], ["micron", [1e-06, ["microns"]]], ["kilometer", [1000.0, ["km", "kilometers"]]], ["foot", [0.3048, ["ft", "feet"]]], ["inch", [0.0254, ["in", "inches"]]], ["yard", [0.9144, ["yrd", "yards"]]], ["mile", [1609.344, ["mi", "miles"]]], ["nautical mile", [1852.0, ["nm", "nauticalmiles"]]], ["fathom", [1.8288, ["fthm", "fathoms"]]], ["latitude degree", [111120.0, ["latitudedegrees"]]], ["latitude minute", [1852.0, ["latitudeminutes"]]]])], ["Oil Concentration", __jsdict([["micron", [1.0, ["microns"]]], ["cubic meter per square kilometer", [1.0, ["m^3/km^2"]]], ["millimeter", [1000.0, ["mm", "millimeters"]]], ["inch", [25400.0, ["in", "inches"]]], ["barrel per acre", [39.2866176, ["bbl/acre"]]], ["barrel per square mile", [0.06138533995, ["bbl/sq.mile"]]], ["gallon per acre", [0.935395632027, ["gal/acre"]]], ["liter per hectare", [0.1, ["liter/hectare"]]]])], ["Area", __jsdict([["square meter", [1.0, ["m^2", "sq m"]]], ["square centimeter", [0.0001, ["cm^2", "sq cm"]]], ["square kilometer", [1000000.0, ["km^2", "sq km"]]], ["acre", [4046.8564, ["acres"]]], ["square mile", [2589988.1, ["sq miles"]]], ["square nautical mile", [3429904, ["sq nm", "nm^2"]]], ["square yard", [0.83612736, ["sq yards", "squareyards"]]], ["square foot", [0.09290304, ["ft^2", "sq foot", "square feet"]]], ["square inch", [0.00064516, ["in^2", "sq inch", "square inches"]]], ["hectare", [10000.0, ["hectares", "ha"]]]])], ["Volume", __jsdict([["cubic meter", [1.0, ["m^3", "cu m", "cubic meters"]]], ["cubic kilometer", [1000000000.0, ["km^3", "cu km", "cubic kilometers"]]], ["cubic centimeter", [1e-06, ["cm^3", "cu cm", "cc"]]], ["barrel (petroleum)", [0.1589873, ["bbl", "barrels", "barrel", "bbls"]]], ["liter", [0.001, ["l", "liters"]]], ["gallon", [0.0037854118, ["gal", "gallons", "usgal"]]], ["gallon (UK)", [0.00454609, ["ukgal", "gallons(uk)"]]], ["million US gallon", [3785.4118, ["milliongallons", "milgal"]]], ["cubic foot", [0.028316847, ["ft^3", "cu feet", "cubicfeet"]]], ["cubic inch", [1.6387064e-05, ["in^3", "cu inch", "cubicinches"]]], ["cubic yard", [0.76455486, ["yd^3", "cu yard", "cubicyards"]]], ["fluid ounce", [2.957353e-05, ["oz", "ounces(fluid)", "fluid oz"]]], ["fluid ounce (UK)", [2.841306e-05, ["ukoz", "fluid oz(uk)"]]]])], ["Temperature", __jsdict([["Kelvin", [[1.0, 0.0], ["K", "degrees k", "degree k", "degrees kelvin", "degree kelvin", "deg k"]]], ["Celsius", [[1.0, 273.16], ["C", "degrees c", "degrees celsius", "deg c", "centigrade"]]], ["Fahrenheit", [[0.555555555556, ((273.16 * (9.0 / 5.0)) - 32.0)], ["F", "degrees f", "degree f", "degrees fahrenheit", "deg f"]]]])], ["Mass", __jsdict([["kilogram", [1.0, ["kg", "kilograms"]]], ["pound", [0.45359237, ["lb", "pounds", "lbs"]]], ["gram", [0.001, ["g", "grams"]]], ["ton", [907.18474, ["tons", "uston"]]], ["metric ton (tonne)", [1000.0, ["tonnes", "metric ton", "metric tons"]]], ["slug", [14.5939, ["slugs"]]], ["ounce", [0.028349523, ["oz", "ounces"]]], ["ton (UK)", [1016.0469, ["ukton", "long ton"]]]])], ["Time", __jsdict([["second", [1.0, ["s", "sec", "seconds"]]], ["minute", [60.0, ["min", "minutes"]]], ["hour", [3600.0, ["hr", "hours", "hrs"]]], ["day", [86400.0, ["days"]]]])], ["Velocity", __jsdict([["meter per second", [1.0, ["m/s", "meters per second", "mps"]]], ["meter per minute", [0.01666666666, ["m/min", "meters per minute"]]], ["centimeter per second", [0.01, ["cm/s"]]], ["kilometer per hour", [0.277777, ["km/h", "km/hr"]]], ["knot", [0.514444, ["kts", "knots"]]], ["mile per hour", [0.44704, ["mph", "miles per hour"]]], ["foot per second", [0.3048, ["ft/s", "ft/sec", "feet per second", "feet/s"]]], ["foot per minute", [0.00508, ["ft/min", "feet per minute", "feet/min"]]], ["foot per hour", [8.4666e-05, ["ft/hr", "feet per hour", "feet/hour"]]]])], ["Discharge", __jsdict([["cubic meter per second", [1.0, ["m^3/s", "cu m/s", "cms"]]], ["cubic meter per min", [(1.0 / 60.0), ["m^3/min"]]], ["cubic meter per hour", [(1.0 / 3600.0), ["m^3/hr"]]], ["liter per second", [0.001, ["l/s", "lps"]]], ["liter per minute", [(0.001 / 60), ["l/min"]]], ["cubic foot per second", [0.02831685, ["cfs", "cu feet/s", "feet^3/s"]]], ["cubic foot per minute", [0.00047194744, ["ft^3/min"]]], ["gallon per day", [4.38126368056e-08, ["gal/day"]]], ["gallon per hour", [1.05150328333e-06, ["gal/hr"]]], ["gallon per minute", [6.3090197e-05, ["gal/min", "gpm"]]], ["gallon per second", [0.0037854118, ["gal/s", "gal/sec"]]], ["barrel per hour", [4.41631388889e-05, ["bbl/hr"]]], ["barrel per day", [1.84013078e-06, ["bbl/day"]]]])], ["Kinematic Viscosity", __jsdict([["Stoke", [1.0, ["St", "stokes"]]], ["centiStoke", [0.01, ["cSt", "centistokes"]]], ["square millimeter per second", [0.01, ["mm^2/s"]]], ["square centimeter per second", [1.0, ["cm^2/s"]]], ["square meter per second", [10000, ["m^2/s"]]], ["square inch per second", [6.4516, ["in^2/s", "squareinchespersecond"]]], ["Saybolt Universal Second", [(1 / 462.0), ["SSU", "SUS"]]], ["Saybolt Furol Second", [0.02116959064, ["SSF", "SFS"]]]])], ["Density", __jsdict([["gram per cubic centimeter", [1.0, ["g/cm^3", "grams per cubic centimeter"]]], ["specific gravity (15°C)", [0.99913, ["S", "specificgravity", "Spec grav", "SG", "specificgravity(15C)"]]], ["kilogram per cubic meter", [0.001, ["kg/m^3"]]], ["pound per cubic foot", [0.016018463, ["lbs/ft^3"]]], ["API degree", [1, ["api"]]]])], ["Concentration In Water", __jsdict([["part per million", [1.0, ["ppm", "parts per million"]]], ["part per billion", [0.001, ["ppb", "parts per billion"]]], ["part per thousand", [1000, ["ppt", "parts per thousand"]]], ["part per trillion", [1e-06, ["parts per trillion", "pptr"]]], ["fraction (decimal)", [1000000.0, ["fraction", "mass per mass"]]], ["percent", [10000.0, ["%", "parts per hundred", "per cent"]]], ["kilogram per cubic meter", [1000, ["kg/m^3", "kg/m3"]]], ["pound per cubic foot", [16018.463, ["lb/ft^3"]]], ["milligram per liter", [1.0, ["mg/l"]]], ["milligram per kilogram", [1.0, ["mg/kg"]]], ["milligram per milliliter", [1000, ["mg/ml"]]], ["microgram per liter", [0.001, ["ug/l"]]], ["nanogram per liter", [1e-06, []]]])]]);
/* Simplify(String)
    returns the string with the whitespace and capitalization removed */
var Simplify = function(String)
{
	
	return "".join(__split_method(String.lower()));
}
...
var GetUnitTypes = function()
{
	...
	return __jsdict_keys(ConvertDataUnits);
}

/* returns a list of all the units available for a given unit type available
    a unit type is something like "mass", "velocity", etc.
    a unit of mass would be "kilogram", "slug", etc. */
var GetUnitNames = function(UnitType)
{
	
	return __jsdict_keys(ConvertDataUnits[((UnitType.__uid__) ? UnitType.__uid__ : ((UnitType instanceof Array) ? JSON.stringify(UnitType) : UnitType))]);
}
...
var FindUnitTypes = function()
{
	var unit_types,Pname;
	unit_types = __jsdict([]);
		var __iter1 = __jsdict_keys(ConvertDataUnits);
	if (! (__iter1 instanceof Array || typeof __iter1 == "string" || __is_typed_array(__iter1) || __is_some_array(__iter1) )) { __iter1 = __object_keys__(__iter1) }
	for (var __i1=0; __i1 < __iter1.length; __i1++) {
		var unit_type = __iter1[ __i1 ];
		if (__test_if_true__(((unit_type instanceof Array ? JSON.stringify(unit_type)==JSON.stringify("Oil Concentration") : unit_type==="Oil Concentration") || (unit_type instanceof Array ? JSON.stringify(unit_type)==JSON.stringify("Concentration In Water") : unit_type==="Concentration In Water"))))
		{
			continue
		}
		var __mtarget__1,PrimaryName,data;
				var __iter2 = __jsdict_items(ConvertDataUnits[((unit_type.__uid__) ? unit_type.__uid__ : ((unit_type instanceof Array) ? JSON.stringify(unit_type) : unit_type))]);
		if (! (__iter2 instanceof Array || typeof __iter2 == "string" || __is_typed_array(__iter2) || __is_some_array(__iter2) )) { __iter2 = __object_keys__(__iter2) }
		for (var __i2=0; __i2 < __iter2.length; __i2++) {
			var __mtarget__1 = __iter2[ __i2 ];
			PrimaryName = __mtarget__1[0];
			data = __mtarget__1[1];
			Pname = PrimaryName;
			unit_types[((Pname.__uid__) ? Pname.__uid__ : ((Pname instanceof Array) ? JSON.stringify(Pname) : Pname))] = unit_type;
						var __iter3 = data[1];
			if (! (__iter3 instanceof Array || typeof __iter3 == "string" || __is_typed_array(__iter3) || __is_some_array(__iter3) )) { __iter3 = __object_keys__(__iter3) }
			for (var __i3=0; __i3 < __iter3.length; __i3++) {
				var n = __iter3[ __i3 ];
				if (__test_if_true__(((unit_type instanceof Array ? JSON.stringify(unit_type)==JSON.stringify("Volume") : unit_type==="Volume") && (n instanceof Array ? JSON.stringify(n)==JSON.stringify("oz") : n==="oz"))))
				{
					continue
				}
				if (__test_if_true__(unit_types.has_key(n)))
				{
					throw new ValueError(__sprintf("Duplicate name in units table: %s", n));
				}
				unit_types[((n.__uid__) ? n.__uid__ : ((n instanceof Array) ? JSON.stringify(n) : n))] = unit_type;
			}
		}
	}
	return unit_types;
...
var GetUnitAbbreviation = function(unit_type, unit)
{
	
	return ConvertDataUnits[((unit_type.__uid__) ? unit_type.__uid__ : ((unit_type instanceof Array) ? JSON.stringify(unit_type) : unit_type))][((unit.__uid__) ? unit.__uid__ : ((unit instanceof Array) ? JSON.stringify(unit) : unit))][1][0];
}
...
var is_same_unit = function(unit1, unit2)
{
	var Synonyms,type1,all_types,type2;
	all_types = FindUnitTypes();
		try {
type1 = __get__(all_types, "__getitem__")([unit1], __NULL_OBJECT__);
type2 = __get__(all_types, "__getitem__")([unit2], __NULL_OBJECT__);
	} catch(__exception__) {
if (__exception__ == KeyError || __exception__ instanceof KeyError) {
return false;
}
	...
	if (!(type1 instanceof Array ? JSON.stringify(type1)==JSON.stringify(type2) : type1===type2))
	{
		return false;
	}
	else
	{
		Synonyms = __get__(Converters, "__getitem__")([Simplify(type1)], __NULL_OBJECT__).Synonyms;
		return (__get__(Synonyms, "__getitem__")([Simplify(unit1)], __NULL_OBJECT__) instanceof Array ? JSON.stringify(__get__(Synonyms, "__getitem__")([Simplify(unit1)], __NULL_OBJECT__))==JSON.stringify(__get__(Synonyms, "__getitem__")([Simplify(unit2)], __NULL_OBJECT__)) : __get__(Synonyms, "__getitem__")([Simplify(unit1)], __NULL_OBJECT__)===__get__(Synonyms, "__getitem__")([Simplify(unit2)], __NULL_OBJECT__));
	}
}

var ConverterClass = function(TypeName, UnitsDict)
{
	this.__init__(TypeName, UnitsDict);
	this.__class__ = ConverterClass;
	this.__uid__ = ("￼" + _PythonJS_UID);
	_PythonJS_UID += 1;
}

ConverterClass.__uid__ = ("￼" + _PythonJS_UID);
_PythonJS_UID += 1;
/* Create a Converter
...
ConverterClass.prototype.__init__ = function(TypeName, UnitsDict)
{
	var Pname;
	this.Name = TypeName;
	this.Synonyms = __jsdict([]);
	this.Convertdata = __jsdict([]);
	var __mtarget__3,PrimaryName,data;
		var __iter4 = __jsdict_items(UnitsDict);
	if (! (__iter4 instanceof Array || typeof __iter4 == "string" || __is_typed_array(__iter4) || __is_some_array(__iter4) )) { __iter4 = __object_keys__(__iter4) }
	for (var __i4=0; __i4 < __iter4.length; __i4++) {
		var __mtarget__3 = __iter4[ __i4 ];
		PrimaryName = __mtarget__3[0];
		data = __mtarget__3[1];
		Pname = Simplify(PrimaryName);
		this.Convertdata[((Pname.__uid__) ? Pname.__uid__ : ((Pname instanceof Array) ? JSON.stringify(Pname) : Pname))] = data[0];
		this.Synonyms[((Pname.__uid__) ? Pname.__uid__ : ((Pname instanceof Array) ? JSON.stringify(Pname) : Pname))] = Pname;
				var __iter5 = data[1];
		if (! (__iter5 instanceof Array || typeof __iter5 == "string" || __is_typed_array(__iter5) || __is_some_array(__iter5) )) { __iter5 = __object_keys__(__iter5) }
		for (var __i5=0; __i5 < __iter5.length; __i5++) {
			var synonym = __iter5[ __i5 ];
			this.Synonyms[((Simplify(synonym).__uid__) ? Simplify(synonym).__uid__ : ((Simplify(synonym) instanceof Array) ? JSON.stringify(Simplify(synonym)) : Simplify(synonym)))] = Pname;
		}
	}
}

ConverterClass.__init__ = function () { return ConverterClass.prototype.__init__.apply(arguments[0], Array.prototype.slice.call(arguments,1)) };
/* Convert(FromUnit, ToUnit, Value)
        returns a __new__>>value, in the units of ToUnit.
        :param FromUnit: the unit the original value is in
        :param ToUnit: the unit you want the value converted to
        :param Value: the original value */
ConverterClass.prototype.Convert = function(FromUnit, ToUnit, Value)
{
...
if (__exception__ == KeyError || __exception__ instanceof KeyError) {
throw new ValueError(__sprintf("invalid unit: %s, %s", [FromUnit, this.Name]));
}
...
if (__exception__ == KeyError || __exception__ instanceof KeyError) {
throw new ValueError(__sprintf("invalid unit: %s, %s", [ToUnit, this.Name]));
}
...
ConverterClass.Convert = function () { return ConverterClass.prototype.Convert.apply(arguments[0], Array.prototype.slice.call(arguments,1)) };
var TempConverterClass = function(TypeName, UnitsDict)
{
	this.__init__(TypeName, UnitsDict);
	this.__class__ = TempConverterClass;
	this.__uid__ = ("￼" + _PythonJS_UID);
	_PythonJS_UID += 1;
}

TempConverterClass.__uid__ = ("￼" + _PythonJS_UID);
_PythonJS_UID += 1;
/* Convert(FromUnit, ToUnit, Value)
        returns a __new__>>value, in the units of ToUnit.
        :param FromUnit: the unit the original value is in
        :param ToUnit: the unit you want the value converted to
        :param Value: the original value */
TempConverterClass.prototype.Convert = function(FromUnit, ToUnit, Value)
{
	var to_val,A1,A2,B1,B2;
	FromUnit = Simplify(FromUnit);
	ToUnit = Simplify(ToUnit);
		try {
FromUnit = __get__(this.Synonyms, "__getitem__")([FromUnit], __NULL_OBJECT__);
	} catch(__exception__) {
if (__exception__ == KeyError || __exception__ instanceof KeyError) {
throw new ValueError(__sprintf("invalid unit: %s, %s", [FromUnit, this.Name]));
}
		...
		try {
ToUnit = __get__(this.Synonyms, "__getitem__")([ToUnit], __NULL_OBJECT__);
	} catch(__exception__) {
if (__exception__ == KeyError || __exception__ instanceof KeyError) {
throw new ValueError(__sprintf("invalid unit: %s, %s", [ToUnit, this.Name]));
}
	...
	A1 = __get__(this.Convertdata, "__getitem__")([FromUnit], __NULL_OBJECT__)[0];
	B1 = __get__(this.Convertdata, "__getitem__")([FromUnit], __NULL_OBJECT__)[1];
	A2 = __get__(this.Convertdata, "__getitem__")([ToUnit], __NULL_OBJECT__)[0];
	B2 = __get__(this.Convertdata, "__getitem__")([ToUnit], __NULL_OBJECT__)[1];
	var __left0,__right1;
	__left0 = Value;
	__right1 = B1;
	to_val = ((((((typeof(__left0) instanceof Array ? JSON.stringify(typeof(__left0))==JSON.stringify("number") : typeof(__left0)==="number")) ? (__left0 + __right1) : __add_op(__left0, __right1)) * A1) / A2) - B2);
	return to_val;
}

TempConverterClass.Convert = function () { return TempConverterClass.prototype.Convert.apply(arguments[0], Array.prototype.slice.call(arguments,1)) };
for (var n in ConverterClass.prototype) {  if (!(n in TempConverterClass.prototype)) {    TempConverterClass.prototype[n] = ConverterClass.prototype[n]  }};
var DensityConverterClass = function(TypeName, UnitsDict)
{
	this.__init__(TypeName, UnitsDict);
	this.__class__ = DensityConverterClass;
	this.__uid__ = ("￼" + _PythonJS_UID);
	_PythonJS_UID += 1;
}

DensityConverterClass.__uid__ = ("￼" + _PythonJS_UID);
_PythonJS_UID += 1;
/* Convert(FromUnit, ToUnit, Value)
        returns a __new__>>value, in the units of ToUnit.
        :param FromUnit: the unit the original value is in
...
throw new ValueError(__sprintf("invalid unit: %s, %s", [ToUnit, this.Name]));
	...
	if (FromUnit instanceof Array ? JSON.stringify(FromUnit)==JSON.stringify("apidegree") : FromUnit==="apidegree")
	{
		var __left2,__right3;
		__left2 = Value;
		__right3 = 131.5;
		Value = (141.5 / (((typeof(__left2) instanceof Array ? JSON.stringify(typeof(__left2))==JSON.stringify("number") : typeof(__left2)==="number")) ? (__left2 + __right3) : __add_op(__left2, __right3)));
		FromUnit = "specificgravity(15°c)";
	}
	if (ToUnit instanceof Array ? JSON.stringify(ToUnit)==JSON.stringify("apidegree") : ToUnit==="apidegree")
	{
		ToVal = ((141.5 / ((Value * __get__(this.Convertdata, "__getitem__")([FromUnit], __NULL_OBJECT__)) / __get__(this.Convertdata, "__getitem__")(["specificgravity(15°c)"], __NULL_OBJECT__))) - 131.5);
	}
	else
	{
		ToVal = ((Value * __get__(this.Convertdata, "__getitem__")([FromUnit], __NULL_OBJECT__)) / __get__(this.Convertdata, "__getitem__")([ToUnit], __NULL_OBJECT__));
	}
	return ToVal;
}

DensityConverterClass.Convert = function () { return DensityConverterClass.prototype.Convert.apply(arguments[0], Array.prototype.slice.call(arguments,1)) };
for (var n in ConverterClass.prototype) {  if (!(n in DensityConverterClass.prototype)) {    DensityConverterClass.prototype[n] = ConverterClass.prototype[n]  }};
var OilQuantityConverter = function()
{
	/*pass*/
	this.__class__ = OilQuantityConverter;
	this.__uid__ = ("￼" + _PythonJS_UID);
	_PythonJS_UID += 1;
}

OilQuantityConverter.__uid__ = ("￼" + _PythonJS_UID);
_PythonJS_UID += 1;
...
OilQuantityConverter.prototype.ToVolume = function(Mass, MassUnits, Density, DensityUnits, VolumeUnits)
{
	var Volume;
...
OilQuantityConverter.ToVolume = function () { return OilQuantityConverter.prototype.ToVolume.apply(arguments[0], Array.prototype.slice.call(arguments,1)) };
/* Convert Oil Mass to Volume
...
OilQuantityConverter.prototype.ToMass = function(Volume, VolUnits, Density, DensityUnits, MassUnits)
{
	var Mass;
	Density = convert("Density", DensityUnits, "kg/m^3", Density);
...
OilQuantityConverter.ToMass = function () { return OilQuantityConverter.prototype.ToMass.apply(arguments[0], Array.prototype.slice.call(arguments,1)) };
Converters = __jsdict([]);
var __mtarget__5,unittype,data;
var __iter6 = __jsdict_items(ConvertDataUnits);
if (! (__iter6 instanceof Array || typeof __iter6 == "string" || __is_typed_array(__iter6) || __is_some_array(__iter6) )) { __iter6 = __object_keys__(__iter6) }
for (var __i6=0; __i6 < __iter6.length; __i6++) {
	var __mtarget__5 = __iter6[ __i6 ];
	unittype = __mtarget__5[0];
	data = __mtarget__5[1];
	if (unittype.lower() instanceof Array ? JSON.stringify(unittype.lower())==JSON.stringify("temperature") : unittype.lower()==="temperature")
	{
		Converters[(("temperature".__uid__) ? "temperature".__uid__ : (("temperature" instanceof Array) ? JSON.stringify("temperature") : "temperature"))] =  new TempConverterClass(unittype, data);
	}
	else
	{
		if (unittype.lower() instanceof Array ? JSON.stringify(unittype.lower())==JSON.stringify("density") : unittype.lower()==="density")
		{
			Converters[(("density".__uid__) ? "density".__uid__ : (("density" instanceof Array) ? JSON.stringify("density") : "density"))] =  new DensityConverterClass(unittype, data);
		}
		else
		{
			Converters[((Simplify(unittype).__uid__) ? Simplify(unittype).__uid__ : ((Simplify(unittype) instanceof Array) ? JSON.stringify(Simplify(unittype)) : Simplify(unittype)))] =  new ConverterClass(unittype, data);
		}
	}
}
/* Convert(FromUnit, ToUnit, Value)
...
var convert = function(UnitType, FromUnit, ToUnit, Value)
{
	...
	UnitType = Simplify(UnitType);
		try {
Converter = Converters[((UnitType.__uid__) ? UnitType.__uid__ : ((UnitType instanceof Array) ? JSON.stringify(UnitType) : UnitType))];
	} catch(__exception__) {
throw new ValueError(__sprintf("Invalid unit type: %s", UnitType));
...
Convert = convert;
__module__.Convert = Convert
__module__.DensityConverterClass = DensityConverterClass
__module__.ConverterClass = ConverterClass
__module__.GetUnitNames = GetUnitNames
__module__.OilQuantityConverter = OilQuantityConverter
__module__.GetUnitAbbreviation = GetUnitAbbreviation
__module__.convert = convert
__module__.Converters = Converters
__module__.TempConverterClass = TempConverterClass
__module__.Simplify = Simplify
__module__.ConvertDataUnits = ConvertDataUnits
__module__.FindUnitTypes = FindUnitTypes
__module__.is_same_unit = is_same_unit
__module__.GetUnitTypes = GetUnitTypes
return __module__
